...
export default function ChatItem({ chat, onDeleteChat }: { chat: Chat; onDeleteChat: (id: string) => void } ) {
  ...
  return (
    <div
      className="group flex items-center space-x-3 rounded-lg px-3 py-2 hover:bg-white/80 transition-colors cursor-pointer bg-white text-green-600 w-64 h-12 shadow-md shadow-slate-300"
      onClick={handleClick}
    >
